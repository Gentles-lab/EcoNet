...
| `ecotype_model.pth` | GAT (fine-tuned on ccRCC): expression → ecotype abundance (2,514 genes) |
| `response_model.pth` | ResponsePredictor (fine-tuned): ecotype features → R/NR. Arch `[32, 16]` |
