...
| `ecotype_model.pth` | Pretrained GAT: expression → ecotype abundance (2,198 genes) |
| `response_model.pth` | ResponsePredictor: ecotype features → R/NR. Arch `[32, 8]`, dropout 0.6 (portable-generalization tuning) |
